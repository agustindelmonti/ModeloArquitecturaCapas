...
namespace Web.Controllers
{
    ...
    public class PersonaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Nombre,Apellido,Direccion,Email,Telefono,FechaNacimiento,Legajo,Role,PlanID")] Persona persona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PersonaID,Nombre,Apellido,Direccion,Email,Telefono,FechaNacimiento,Legajo,Role,PlanID")] Persona persona)
        {
            if (ModelState.IsValid)
            {
