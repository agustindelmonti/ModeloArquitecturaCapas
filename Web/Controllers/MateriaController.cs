...
namespace Web.Controllers
{
    ...
    public class MateriaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Descripcion,HsSemanales,HsTotales,PlanID")] Materia materia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MateriaID,Descripcion,HsSemanales,HsTotales,PlanID")] Materia materia)
        {
            if (ModelState.IsValid)
            {
